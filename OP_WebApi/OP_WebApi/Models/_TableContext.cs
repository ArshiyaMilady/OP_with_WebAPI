    ...
    public class TableContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer(@"workstation id=OrderPDB.mssql.somee.com;data source=OrderPDB.mssql.somee.com;packet size=4096;user id=mehdy_ra_SQLLogin_1;pwd=dxcgx7o16c;persist security info=False;initial catalog=OrderPDB"); 
